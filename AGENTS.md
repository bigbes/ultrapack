...
- `agents/` — subagents (`@implementer`, `@implementer-smart`, `@implementer-deep`, `@reviewer`, `@explorer`, `@summarizer`, `@researcher`, `@finder`, `@librarian`, `@oracle`, `@diff-explainer`, `@rush`, `@smart`, `@deep`, `@look-at`)
