...
- **How real projects do X** → web search, then web fetch the promising results. GitHub searches are gold.
- **Current codebase context** → file search, text search, file reads. What does *this* project already do?
